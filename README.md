...
Bienvenidos al repositorio de mi portafolio personal, disponible en línea en [abzikel.dev](https://abzikel.dev).

Soy **Ingeniero en Desarrollo de Software** especializado en Desarrollo Web Full-Stack, Análisis de Datos y Automatizaciones. Mi filosofía de trabajo se basa en diseñar soluciones tecnológicas a la medida, entregando productos altamente optimizados que maximicen el rendimiento y la seguridad.

## Proyectos Destacados

### Sistema ETR
Sistema de Entrenamiento en Tiro de Reacción para profesionales y entusiastas del tiro deportivo.
...
Aplicación móvil de uso interno para consultoría agrícola que automatiza la generación de reportes y diagnósticos de cultivos.

![Android](https://img.shields.io/badge/Android-3DDC84?style=flat-square&logo=android&logoColor=white) ![Firebase](https://img.shields.io/badge/Firebase-FFCA28?style=flat-square&logo=firebase&logoColor=black) ![Cloud Functions](https://img.shields.io/badge/Cloud_Functions-4285F4?style=flat-square&logo=google-cloud&logoColor=white)

### Plugin de Reservas MultiTire Shop
Solución personalizada para WordPress enfocada en la gestión de citas de servicios automotrices con notificaciones automatizadas.
